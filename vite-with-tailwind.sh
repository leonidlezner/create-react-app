...
curl -s https://raw.githubusercontent.com/leonidlezner/create-react-app/main/snippets/React%20Component.code-snippets > ./.vscode/React%20Component.code-snippets
